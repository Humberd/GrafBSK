...
public class DrawingList<E>
    ...
    transient DrawingPanel panel;

    public DrawingList(DrawingPanel panel) {
        super();
        this.panel = panel;
    }

    private void addMouseAdapters(E e) {
        if (e instanceof DrawingClass) {
            DrawingClass dr = (DrawingClass) e;
            ArrayList<MouseAdapter> list = dr.getMouseAdapters();
            for (MouseAdapter adapter : list) {
    ...
    private void removeMouseAdapters(E e) {
        if (e instanceof DrawingClass) {
            DrawingClass dr = (DrawingClass) e;
            ArrayList<MouseAdapter> list = dr.getMouseAdapters();
            for (MouseAdapter adapter : list) {
